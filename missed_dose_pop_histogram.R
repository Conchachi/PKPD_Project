...
ggsave(filename = 'figure_histogram_1.png', plot = figure_histogram_1, path = 'missed_dose_pop_data/', width = 24, height = 24 )
...
ggsave(filename = 'figure_histogram_2.png', plot = figure_histogram_2, path = 'missed_dose_pop_data/', width = 24, height = 24 )
